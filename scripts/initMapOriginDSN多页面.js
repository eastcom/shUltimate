...
function showAllIndexInfo(disName,flag){
    ...
    var src4 = "pagesDSN/rmgcBig.html?name=";
    constructDomTrend(disName,'hotGrounds',src4);
...
function showAllIndexInfoSmall(disName,flag){
    ...
    constructDomTrend(disName,'dataThroughPut1',src2);
    var src4 = "pagesDSN/rmgcBigSmall.html?name=";
    constructDomTrend(disName,'hotGrounds',src4);
...
function callDivRMGCMax(str){
    document.getElementById("hotGrounds").style.visibility = "visible";
    document.getElementById("hotGrounds").innerHTML = '';
    $('#hotGrounds').addClass('img-preview');
    var winHeight = $(document).height(),
        winWidth = $(document).width();
    $('#hotGrounds').css({position: 'absolute', width: '880px', height: '480px', left: winWidth/4, top: winHeight/7, 'background-color': '#none', border: 'none'});
    document.getElementById("hotGrounds").innerHTML = '<iframe width="880px" frameborder=no height="480px" src=' + str + '></iframe>';
}
function closeDivRMGC(){
    document.getElementById("hotGrounds").innerHTML = '';
    document.getElementById("hotGrounds").style.visibility = "hidden";
}
function callDivRMGCNormal(){
    $('#hotGrounds').empty();
    var str = "pagesDSN/rmgcBig.html?name=";
    $('#hotGrounds').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '460px', 'background-color': 'none', border: 'none'});
    constructDomTrend(heatIndexDis,'hotGrounds',str);
}
