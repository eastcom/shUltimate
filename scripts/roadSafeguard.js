...
function addValNBGJ(arr){
    ...
    $.ajax({
        ...
        .done(function(data){
            //console.log(data);
            roadNB && (map.removeLayer(roadNB),switchControl.removeLayer(roadNB),roadNB.clearLayers());
            var resultArr = [];
            for(var i= 0,lenI=arr.length; i<lenI; ++i){
                var name = arr[i].name;
...
function initBaiduMap(){
    ...
    }).setView([31.211189,121.470452], 13);
    //自定义地图数据源
	//tileSize==512
...
function addImportantData(){
    ...
    var bigGroupData = ['游玩场所','商业场所','交通枢纽','高速','高架','收费站'];
    ...
    $.ajax({
        ...
        .done(function(data){
            ...
            for(var name in data){
                ...
                name === '高架' && ( smData = (targetObj.total/10000).toFixed(2));
    ...
    $.ajax({
        ...
        .done(function(data){
            ...
            for(var name in data){
                ...
                name === '高架' && ( smData = (targetObj[indexName]/1024/1024).toFixed(2));
