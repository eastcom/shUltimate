...
function initBaiduMap(){
    ...
    }).setView([31.312888,121.441563], 13);
    //自定义地图数据源
	//tileSize==512
        ...
        $.ajax({
            ...
            .done(function(data){
                ...
                for(var i= 0,lenI=data.length; i<lenI; ++i){
                    ...
                    if(hot_type === 1 && area_name !== '地铁保障') continue;
...
function createThirdCustomDiv(str){
    ...
    function createMenuDiv(top,left,str){
        ...
        parentdiv.addClass('img-preview');
        parentdiv.css({
            'position':'absolute', 'left': left + 20, 'top': top , 'width': '300px', 'border': '1px solid #003250', 'background-color': '#003250', 'color': 'white'
        });
        parentdiv.appendTo('body');            //将父div添加到body中
        $.ajax({
