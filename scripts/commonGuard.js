...
function showAllIndexInfo(disName,flag){
    ...
    var src1 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'userData1' + "&width=600" + "&height=200" + "&isBig=normal" + "&imgName=fourCharts" + "&businessName=" + encodeURIComponent('用户数') + "&pcVersion=false" ;
    constructDomTrendCommon(disName,'userData1',src1);
    var src2 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'dataThroughPut1' + "&width=600" + "&height=200" + "&isBig=normal" + "&imgName=fourCharts" + "&businessName=" + encodeURIComponent('流量') + "&pcVersion=false";
    constructDomTrendCommon(disName,'dataThroughPut1',src2);
    var src4 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'hotGrounds' + "&width=600" + "&height=400" + "&isBig=normal" + "&imgName=indexBackGroundBig" + "&businessName=" + encodeURIComponent('热门场馆') + "&pcVersion=false";    
    constructDomTrendCommon(disName,'hotGrounds',src4);
    var src3 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'hotTerminal1' + "&width=600" + "&height=400" + "&isBig=normal" + "&imgName=indexBackGroundBig" + "&businessName=" + encodeURIComponent('热门应用') + "&pcVersion=false";
    //console.log(flag);
    //数据为0时不刷新    
    if(flag === true){
...
function showAllIndexInfoSmall(disName,flag){
    ...
    var src1 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'userData1' + "&width=400" + "&height=200" + "&isBig=small" + "&imgName=indexBackGroundBigSmall" + "&businessName=" + encodeURIComponent('用户数') + "&pcVersion=true";
    constructDomTrendCommon(disName,'userData1',src1);
    var src2 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'dataThroughPut1' + "&width=400" + "&height=200" + "&isBig=small" + "&imgName=indexBackGroundBigSmall" + "&businessName=" + encodeURIComponent('流量') + "&pcVersion=true";
    constructDomTrendCommon(disName,'dataThroughPut1',src2);
    var src4 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'hotGrounds' + "&width=400" + "&height=200" + "&isBig=small" + "&imgName=indexBackGroundBigSmall" + "&businessName=" + encodeURIComponent('热门场馆') + "&pcVersion=true";    
    constructDomTrendCommon(disName,'hotGrounds',src4);
    var src3 = "pagesDSN/commonLL.html?name=" + disName + "&parentId=" + 'hotTerminal1' + "&width=400" + "&height=200" + "&isBig=small" + "&imgName=indexBackGroundBigSmall" + "&businessName=" + encodeURIComponent('热门应用') + "&pcVersion=true";
    //数据为0时不刷新    
    if(flag === true){
...
function getParas2SetChartSize(flag){    
    ...
    if(flag){//单屏时
        ...
        refreshTime = setInterval(function () {
                heatIndexDis === '迪士尼' && addAllDis();
                heatIndexDis !== '迪士尼' && addAllStadium();
