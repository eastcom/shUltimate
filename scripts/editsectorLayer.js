...
function addSectorXQ(latlng,radius,start,stop,name,lacci,hotspot,hotId,type){
    ...
    if(type === '4G'){
        ...
        L.circle(latlng, radius, {
            ...
            startAngle: start,
            stopAngle: stop
        }).bindPopup(heatPopup3G).addTo(sectorLayer);
    }
...
function callRightScreenInfo(name,lacci,type){
    ...
    //console.log(lac,ci); 
    var pareUrl = '<iframe width="1280px" frameborder=no height="510px" src='+"http://" + baseUrl + ":8080/INAS/pages/local-lsm/cellKpis.jsp?cellname=" + encodeURIComponent(name) + "&celltype=" + encodeURIComponent(type) + '&lac=' + lac + '&ci=' + ci + '></iframe>';
...
function callRightScreenInfoPQ(name){
    ...
    var pareUrl = '<iframe width="1280px" frameborder=no height="500px" src='+"http://" + baseUrl + ":8080/INAS/pages/local-lsm/cellKpis.jsp?hotspot=" + encodeURIComponent(name) + '></iframe>';
    customDiv.html(pareUrl);
    customDiv.appendTo('body');
}
//关闭左屏页面
...
function showAllIndexInfo(disName,flag){
    ...
    $('#userData1').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '40px', 'background-color': 'none', border: 'none'});
    $('#dataThroughPut1').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '360px', 'background-color': 'none', border: 'none'});
    $('#hotTerminal1').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '680px', 'background-color': 'none', border: 'none'});
...
function showAllIndexInfoSmall(disName,flag){
    ...
    $('#userData1').css({position: 'absolute', width: '400px', height: '200px', left: '80px', top: '180px', 'background-color': 'none', border: 'none'});
    $('#dataThroughPut1').css({position: 'absolute', width: '400px', height: '200px', left: '80px', top: '420px', 'background-color': 'none', border: 'none'});
    $('#hotTerminal1').css({position: 'absolute', width: '400px', height: '200px', left: '80px', top: '660px', 'background-color': 'none', border: 'none'});
    
    var src1 = "pagesDSN/yhsBigSmall.html?name=";
    constructDomTrend(disName,'userData1',src1);
    var src2 = "pagesDSN/llBigSmall.html?name=";
    constructDomTrend(disName,'dataThroughPut1',src2);
    var src3 = "pagesDSN/rmyyBigSmall.html?name=";
    //数据为0时不刷新    
    if(flag === true){
...
function checkHotAPP(disName,src3){
    ...
    var userUrl = 'http://' + baseUrl + ':8080/stream/union/apps/hotspot-time-rank?time=' + timeEnd + '&hotspot=' + encodeURIComponent(heatIndexDis);
    //console.log(userUrl);
    $.ajax({
        url: userUrl,
        type: 'get',
...
function callDivLLMax(str){
    ...
    var winHeight = $(document).height(),
        winWidth = $(document).width();
    $('#dataThroughPut1').css({position: 'absolute', width: '880px', height: '480px', left: winWidth/4, top: winHeight/7, 'background-color': 'none', border: 'none'});
...
function closeDivYHS(){
    document.getElementById("userData1").innerHTML = '';
    document.getElementById("userData1").style.visibility = "hidden";
}
function callDivYHSMax(str){
    document.getElementById("userData1").style.visibility = "visible";
    document.getElementById("userData1").innerHTML = '';
    $('#userData1').addClass('img-preview');
    var winHeight = $(document).height(),
        winWidth = $(document).width();
    $('#userData1').css({position: 'absolute', width: '880px', height: '480px', left: winWidth/4, top: winHeight/7, 'background-color': 'none', border: 'none'});
    document.getElementById("userData1").innerHTML = '<iframe width="880px" frameborder=no height="480px" src=' + str + '></iframe>';
}
function callDivYHSNormal(){
    $('#userData1').empty();
    var str = "pagesDSN/yhsBig.html?name=";
    $('#userData1').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '40px', 'background-color': 'none', border: 'none'});
    constructDomTrend(heatIndexDis,'userData1',str);
}
function closeDivRMYY(){
    document.getElementById("hotTerminal1").innerHTML = '';
    document.getElementById("hotTerminal1").style.visibility = "hidden";
}
function callDivRMYYMax(str){
    document.getElementById("hotTerminal1").style.visibility = "visible";
    document.getElementById("hotTerminal1").innerHTML = '';
    $('#hotTerminal1').addClass('img-preview');
    var winHeight = $(document).height(),
        winWidth = $(document).width();
    $('#hotTerminal1').css({position: 'absolute', width: '880px', height: '480px', left: winWidth/4, top: winHeight/7, 'background-color': '#none', border: 'none'});
    document.getElementById("hotTerminal1").innerHTML = '<iframe width="880px" frameborder=no height="480px" src=' + str + '></iframe>';
}
function callDivRMYYNormal(){
    $('#hotTerminal1').empty();
    var str = "pagesDSN/rmyyBig.html?name=";
    $('#hotTerminal1').css({position: 'absolute', width: '600px', height: '300px', left: '80px', top: '680px', 'background-color': 'none', border: 'none'});
    constructDomTrend(heatIndexDis,'hotTerminal1',str);
}
...
function addAllDis(){
    ...
    var url = 'http://' + baseUrl + ':8080/services/ws/fast_query/area/re/re_areaHotRel?hotspot=' + encodeURIComponent(heatIndexDis) + '&hot_type=1&isAllInfo=true';
    //console.log(url);
    $.ajax({
        url: url,
        type: 'GET',
...
function addPoppupPQ(arr){
    ...
    idStr += arr[lenI].id;
    //console.log(idStr);
    var url = 'http://' + baseUrl + ':8080/services/ws/fast_query/area/a/gridHotPf?time=&hot_id=' + idStr;
    $.ajax({
        url: url,
        type: 'get'
    })
...
function callDetailedInfoFromChild(str){
    var url = 'http://' + baseUrl + ':8080/services/ws/fast_query/area/pm/streamAlarmByHot?mtime=10&hotspot=' + encodeURIComponent(heatIndexDis);
    //console.log(url);
    $.ajax({
        url: url,
        type: 'get',
...
function addRectangleLayer(){
    var url = 'http://' + baseUrl + ':8080/services/ws/fast_query/area/pm/gridPf';
    //console.log(url);
    $.ajax({
        url: url,
        type: 'GET',
