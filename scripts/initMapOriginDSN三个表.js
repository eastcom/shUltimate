...
function queryByRectangle(maxLat,maxLng,minLat,minLng) {
    ...
    //console.log("http://"+baseUrl+':'+basePort+'/services/ws/fast_query/gis/kpi/findGridCell?business_circles_name="+encodeURIComponent(heatIndexDis) +"&minLongitude=" +minLng +"&minLatitude=" +minLat + "&maxLongitude=" + maxLng +"&maxLatitude=" + maxLat)
    $.ajax({
        url: temUrl,
        type: 'GET',
        dataType: 'json',
